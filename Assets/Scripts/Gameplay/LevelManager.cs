...
public class LevelManager : MonoBehaviour {
    ...
    public bool blkEvent;

    public static GameObject RisingSmokePuff, SmokePuff, SmokePuffTrail;
    ...
    private void Start()
    {
        ...
        SmokePuff = Resources.Load<GameObject>("Objects/Effects/SmokePuff");
        RisingSmokePuff = Resources.Load<GameObject>("Objects/Effects/RisingSmokePuff");
        SmokePuffTrail = Resources.Load<GameObject>("Objects/Effects/SmokePuffTrail");
    }
